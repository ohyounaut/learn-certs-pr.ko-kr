...
[MCT 지원팀](https://aka.ms/mctforum)에 MCT 인증 절차 및 프로그램 요건에 대한 궁금한 점을 문의해 주세요.
...
1. [코스웨어 시장](https://shop.courseware-marketplace.com/)에서 MCT 쿠폰을 구입하십시오.
...
- 시험 준비 및 전문성 개발을 위한 리소스를 제공하는 전자책 할인 혜택
